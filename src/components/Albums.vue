...
export default {
  ...
  methods: {
    initialize () {
      this.$store.commit("albums/getAllAlbums")
    },
    ...
    editItem (item) {
      ...
      this.dialog = true
      this.$store.commit("albums/updateAlbum", this.editedItem)
    },
    ...
    deleteItem (item) {
      ...
      this.$store.commit("albums/removeAlbum", this.editedItem.id)
    },
    ...
    save () {
      if (this.editedIndex > -1) {
        ...
        this.$store.commit("albums/addAlbum", this.editedItem)
      }
      this.close()
    },
  },
